...
class ShowTodo extends Component {
  ...
  render() {
    ...
    const selectOptions = [{ state: STATE_UPDATE_PROGRESS, title: 'update progress' }, { state: STATE_TODO, title: 'Planned' }, { state: STATE_DOING, title: 'Started' }, { state: STATE_DONE, title: 'Done' }]
